...
<footer class="max-w-7xl mx-auto text-black">
  <div class="px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
    <!-- Logo -->
    <div>
    ...
    <div>
      ...
      <ul class="space-y-2">
        <li><a href="#" class="hover:underline">École de formation</a></li>
        <li><a href="#" class="hover:underline">Entreprise</a></li>
        <li><a href="#" class="hover:underline">ONG</a></li>
      </ul>
    </div>
