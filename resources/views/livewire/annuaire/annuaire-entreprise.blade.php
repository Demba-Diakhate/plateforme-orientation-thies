<div class="max-w-7xl mx-auto px-4 py-10">
    <h1 class="text-3xl font-bold mb-6 text-center">Annuaire des entreprises à Thiès</h1>
    <form method="GET" action="{{ route('annuaire') }}" class="mb-6 flex flex-col sm:flex-row items-center gap-4">
    <input
        type="text"
        name="query"
        value="{{ request('query') }}"
    ...
    <button type="submit" class="px-6 py-2 bg-vertSombre text-white rounded hover:bg-vertClair">
        Rechercher
    </button>
</form>
        ...
        <table class="min-w-full">
            <thead class="bg-vertClair/20 border-b-2 border-vertSombre">
                <tr>
                    ...
                    <th class="text-left py-3 px-4">Nom de l'entreprise</th>
