...
<div class="card">
     <div class="card-body">
          <form action="{{ route('entreprise.emplois.store') }}" method="POST" enctype="multipart/form-data"
               class="row g-3">
               @csrf
               <div class="col-md-6">
               ...
               <div class="col-md-6">
                    ...
                    <select name="type_contrat" class="form-select" required>
                         ...
                         <option value="Freelance" {{ old('type_contrat')=='Freelance' ? 'selected' : '' }}>Freelance
                         </option>
               ...
               <div class="col-12 text-end">
                    <button type="submit" class="btn btn-success">
                         <i class="bi bi-check-circle"></i> Publier l'emploi
                    </button>
               </div>
          </form>
     </div>
