     ...
     <div class="ps-3">
          <nav aria-label="breadcrumb">
               <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Liste des centres de formation</li>
               </ol>
          </nav>
     </div>
</div>
               ...
               <table class="table table-striped table-bordered" id="example2">
                    ...
                    <tbody>
                         ...
                         <tr>
                              <td>
                                   @if($ecole->logo)
                                   <img src="{{ asset('storage/' . $ecole->logo) }}" alt="Logo" width="40" height="40">
                                   @else
                                   -
                                   @endif
                              </td>
                              ...
                              <td>{{ $ecole->created_at ? $ecole->created_at->format('d/m/Y') : '-' }}</td>
                              <td>
