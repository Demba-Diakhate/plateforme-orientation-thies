     ...
     <ul class="metismenu" id="menu">
          ...
          {{-- <li>
               ...
               <ul>
                    ...
                    <li> <a href="app-file-manager.html"><i class="bi bi-arrow-right-short"></i>File
                              Manager</a>
                    </li>
          ...
          <li>
               ...
               <ul>
                    ...
                    <li> <a href="component-navs-tabs.html"><i class="bi bi-arrow-right-short"></i>Navs &
                              Tabs</a>
                    </li>
          ...
          <li>
               ...
               <ul>
                    <li> <a href="icons-line-icons.html"><i class="bi bi-arrow-right-short"></i>Line
                              Icons</a>
                    </li>
          ...
          <li>
               ...
               <ul>
                    <li> <a href="form-elements.html"><i class="bi bi-arrow-right-short"></i>Form
                              Elements</a>
                    </li>
                    <li> <a href="form-input-group.html"><i class="bi bi-arrow-right-short"></i>Input
                              Groups</a>
                    </li>
                    <li> <a href="form-layouts.html"><i class="bi bi-arrow-right-short"></i>Forms
                              Layouts</a>
                    </li>
                    <li> <a href="form-validations.html"><i class="bi bi-arrow-right-short"></i>Form
                              Validation</a>
                    </li>
                    <li> <a href="form-wizard.html"><i class="bi bi-arrow-right-short"></i>Form
                              Wizard</a>
                    </li>
          ...
          <li>
               ...
               <ul>
                    <li> <a href="table-basic-table.html"><i class="bi bi-arrow-right-short"></i>Basic
                              Table</a>
                    </li>
                    <li> <a href="table-advance-tables.html"><i class="bi bi-arrow-right-short"></i>Advance Tables</a>
                    </li>
                    <li> <a href="table-datatable.html"><i class="bi bi-arrow-right-short"></i>Data
                              Table</a>
                    </li>
               </ul>
          </li>
          ...
          <li>
               ...
               <ul>
                    ...
                    <li> <a href="pages-blank-page.html" target="_blank"><i class="bi bi-arrow-right-short"></i>Blank
                              Page</a>
                    </li>
               </ul>
          </li>
