...
<div class="max-w-7xl mx-auto px-4 py-10">
    <h1 class="text-3xl font-bold mb-6 text-center">Annuaire des ONG à Thiès</h1>
    <form method="GET" action="{{ route('annuaire-ong') }}" class="mb-6 flex flex-col sm:flex-row items-center gap-4">
    <input
        type="text"
        name="query"
        value="{{ request('query') }}"
    ...
    @if($entreprises->isEmpty())
        <tr class="p-6 text-center text-vertSombre font-semibold">
            Aucun ONG ne correspond à votre recherche.
        </tr>
    @else
